...
public class MoRenQiDianAddressAdapter1 extends RecyclerView.Adapter<MoRenQiDianAddressAdapter1.ViewHolder>{

    private Context context;
    private List<MoRenQiDianAddressEntity.ResponseBean.EaddlistBean> list;
    private OnClickHang onClickHang;
    private OnClickMoRen onClickMoRen;
    private OnClickDelete onClickDelete;
    public MoRenQiDianAddressAdapter1(Context context, List<MoRenQiDianAddressEntity.ResponseBean.EaddlistBean> list) {
    ...
    @Override
    public MoRenQiDianAddressAdapter1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MoRenQiDianAddressAdapter1.ViewHolder holder, final int position) {

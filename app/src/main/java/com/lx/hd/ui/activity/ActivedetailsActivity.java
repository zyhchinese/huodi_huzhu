    ...
    protected void initWidget() {
        ...
        img_fenxiang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OthreShare.showShare(ActivedetailsActivity.this,primaryNew.getActivityname(),"", "http://www.huodiwulian.com/logo_hz.png", "http://www.huodiwulian.com/hdsywz/page/xinwen/xinwenxiangqingm.html?id="+primaryNew.getId()+"&type=2");
            }
        });
